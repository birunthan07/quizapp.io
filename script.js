...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function startTimer() {
        timerInterval = setInterval(() => {
            ...
            if (timeRemaining <= 20) { // Add this condition
    ...
    function markAnswer() {
        ...
        if (selectedOption) {
            if (selectedOption.value === questionArray[currentQuestionIndex].answer) {
                correctAnswers++;
            }
        }
    }
    ...
    function displayResult() {
        ...
        resultCardElement.textContent = `Quiz completed! You got ${correctAnswers} out of ${questionArray.length} correct.`;
